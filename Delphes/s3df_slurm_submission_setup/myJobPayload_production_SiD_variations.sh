...
if [[ "$process" == "Z" ]]; then
    cd __DELPHES_DIR__/production_for_training_Oct2024/SiD_variations/z_${flavor}_${detector}
elif [[ "$process" == "Z_v2" ]]; then
    cd __DELPHES_DIR__/production_for_training_Oct2024/SiD_variations/z_v2_${flavor}_${detector}
elif [[ "$process" == "nunuH" ]]; then
    cd __DELPHES_DIR__/production_for_training_Oct2024/SiD_variations/zhiggs_${flavor}_${detector}
elif [[ "$process" == "nunuHH" ]]; then
    cd __DELPHES_DIR__/production_for_training_Oct2024/SiD_variations/zhiggshiggs_${flavor}_${detector}
fi
