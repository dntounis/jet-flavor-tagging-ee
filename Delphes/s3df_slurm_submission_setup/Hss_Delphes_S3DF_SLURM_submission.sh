...
export ALRB_CONT_RUNPAYLOAD="/fs/ddn/sdf/group/atlas/d/dntounis/Hss_setup_test/Delphes/s3df_slurm_submission_setup/myJobPayload_production.sh $FLAVOR $NUMBER "
