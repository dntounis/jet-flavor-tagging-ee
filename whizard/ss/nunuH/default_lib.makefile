...
SOURCES += procH_i1.f90
OBJECTS += procH_i1.lo
procH_i1.f90:
	@echo  "  OMEGA     procH_i1.f90"
	@/cvmfs/sw-nightlies.hsf.org/key4hep/releases/2024-12-24/x86_64-almalinux9-gcc14.2.0-opt/whizard/3.1.4-xqzlt3/bin/omega_SM.opt -o procH_i1.f90 -target:whizard -target:parameter_module parameters_SM -target:module opr_procH_i1 -target:md5sum '27B58CBCC969E20D37E74A9C8F6D3D41' -target:openmp -fusion:progress -scatter 'e- e+ -> nue:numu:nutau nuebar:numubar:nutaubar H' 
clean-procH_i1:
	@echo  "  RM        procH_i1.f90,.mod,.lo"
	@rm -f procH_i1.f90
	@rm -f opr_procH_i1.mod
	@rm -f procH_i1.lo
CLEAN_SOURCES += procH_i1.f90
CLEAN_OBJECTS += opr_procH_i1.mod
CLEAN_OBJECTS += procH_i1.lo
procH_i1.lo: procH_i1.f90
	$(LTFCOMPILE) $<
