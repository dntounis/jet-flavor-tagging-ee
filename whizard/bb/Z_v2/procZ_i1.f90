...
!
!   /cvmfs/sw-nightlies.hsf.org/key4hep/releases/2024-12-27/x86_64-almalinux9-gcc14.2.0-opt/whizard/3.1.4-xqzlt3/bin/omega_SM.opt -o procZ_i1.f90 -target:whizard -target:parameter_module parameters_SM -target:module opr_procZ_i1 -target:md5sum 92B6EE708126E673B92932A97985329A -target:openmp -fusion:progress -scatter "e- e+ -> b bbar"
!
...
module opr_procZ_i1
  ...
  data table_flavor_states(:,   1) /  11, -11,   5,  -5 / ! e- e+ b bbar
  ...
  type thread_local_data
    type(spinor) :: owf_fd3_i1_p4, owf_fl1_p1
    type(conjspinor) :: owf_fd3b_o1_p3, owf_fl1b_p2
    type(vector) :: owf_fa_p12, owf_fz_p12
    complex(kind=default) :: oks_fl1_fl1b_fd3_i1_fd3b_o1
...
contains
  ...
  pure function md5sum ()
    ...
    md5sum = "92B6EE708126E673B92932A97985329A"
  end function md5sum
...
!$OMP PARALLEL DO DEFAULT(SHARED) PRIVATE(s, h, tld) SCHEDULE(STATIC)
    do hi = 1, hel_finite
      ...
      tld%owf_fd3b_o1_p3 = ubar (mass(5), p3, s(3))
      tld%owf_fd3_i1_p4 = v (mass(5), p4, s(4))
      call compute_fusions_0001 (tld)
      call compute_brakets_0001 (tld)
      amp(1,1,h) = tld%oks_fl1_fl1b_fd3_i1_fd3b_o1
    end do
!$OMP END PARALLEL DO
  ...
  type(thread_local_data), intent(inout) :: tld
      tld%oks_fl1_fl1b_fd3_i1_fd3b_o1 = 0
      tld%oks_fl1_fl1b_fd3_i1_fd3b_o1 = tld%oks_fl1_fl1b_fd3_i1_fd3b_o1 &
         + tld%owf_fa_p12*( &
         + v_ff(qdwn,tld%owf_fd3b_o1_p3,tld%owf_fd3_i1_p4))
      tld%oks_fl1_fl1b_fd3_i1_fd3b_o1 = tld%oks_fl1_fl1b_fd3_i1_fd3b_o1 &
         + tld%owf_fz_p12*( &
         + va_ff(gncdwn(1),gncdwn(2),tld%owf_fd3b_o1_p3,tld%owf_fd3_i1_p4))
      tld%oks_fl1_fl1b_fd3_i1_fd3b_o1 = &
         - tld%oks_fl1_fl1b_fd3_i1_fd3b_o1 ! 2 vertices, 1 propagators
