...
# Included libraries
FCINCL = -I/cvmfs/sw-nightlies.hsf.org/key4hep/releases/2024-12-25/x86_64-almalinux9-gcc14.2.0-opt/whizard/3.1.4-xqzlt3/lib/mod/whizard -I/cvmfs/sw-nightlies.hsf.org/key4hep/releases/2024-12-25/x86_64-almalinux9-gcc14.2.0-opt/whizard/3.1.4-xqzlt3/lib/mod/omega -I/cvmfs/sw-nightlies.hsf.org/key4hep/releases/2024-12-25/x86_64-almalinux9-gcc14.2.0-opt/whizard/3.1.4-xqzlt3/lib/mod/models -I/cvmfs/sw-nightlies.hsf.org/key4hep/releases/2024-09-21/x86_64-almalinux9-gcc14.2.0-opt/openloops/2.1.2-eh75iu/lib_src/openloops/mod 
...
DVIPS = dvips
PS2PDF = ps2pdf14
TEX_FLAGS = "/cvmfs/sw-nightlies.hsf.org/key4hep/releases/2024-12-25/x86_64-almalinux9-gcc14.2.0-opt/whizard/3.1.4-xqzlt3/share/texmf/whizard:$$TEXINPUTS"
MP_FLAGS  = "/cvmfs/sw-nightlies.hsf.org/key4hep/releases/2024-12-25/x86_64-almalinux9-gcc14.2.0-opt/whizard/3.1.4-xqzlt3/share/texmf/whizard:$$MPINPUTS"

# Libtool
LIBTOOL = /cvmfs/sw-nightlies.hsf.org/key4hep/releases/2024-12-25/x86_64-almalinux9-gcc14.2.0-opt/whizard/3.1.4-xqzlt3/lib/whizard/libtool
...
SOURCES += procHH_i1.f90
OBJECTS += procHH_i1.lo
procHH_i1.f90:
	@echo  "  OMEGA     procHH_i1.f90"
...
clean-procHH_i1:
	@echo  "  RM        procHH_i1.f90,.mod,.lo"
	@rm -f procHH_i1.f90
	@rm -f opr_procHH_i1.mod
	@rm -f procHH_i1.lo
CLEAN_SOURCES += procHH_i1.f90
CLEAN_OBJECTS += opr_procHH_i1.mod
CLEAN_OBJECTS += procHH_i1.lo
procHH_i1.lo: procHH_i1.f90
	$(LTFCOMPILE) $<
