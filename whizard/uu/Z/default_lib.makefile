...
procZ_i1.f90:
	...
	@/cvmfs/sw-nightlies.hsf.org/key4hep/releases/2024-12-24/x86_64-almalinux9-gcc14.2.0-opt/whizard/3.1.4-xqzlt3/bin/omega_SM.opt -o procZ_i1.f90 -target:whizard -target:parameter_module parameters_SM -target:module opr_procZ_i1 -target:md5sum '3DA9896BF6C5C03ED0BD735E1A6BE7BA' -target:openmp -fusion:progress -scatter 'e- e+ -> Z' 
clean-procZ_i1:
