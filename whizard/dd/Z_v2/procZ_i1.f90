...
module opr_procZ_i1
  ...
  data table_flavor_states(:,   1) /  11, -11,   1,  -1 / ! e- e+ d dbar
  ...
  type thread_local_data
    type(spinor) :: owf_fd1_i1_p4, owf_fl1_p1
    type(conjspinor) :: owf_fd1b_o1_p3, owf_fl1b_p2
    type(vector) :: owf_fa_p12, owf_fz_p12
    complex(kind=default) :: oks_fl1_fl1b_fd1_i1_fd1b_o1
...
contains
  ...
  pure function md5sum ()
    ...
    md5sum = "FEA46B2406387C43D6412451A8EE3EF0"
  end function md5sum
...
!$OMP PARALLEL DO DEFAULT(SHARED) PRIVATE(s, h, tld) SCHEDULE(STATIC)
    do hi = 1, hel_finite
      ...
      tld%owf_fd1b_o1_p3 = ubar (mass(1), p3, s(3))
      tld%owf_fd1_i1_p4 = v (mass(1), p4, s(4))
      call compute_fusions_0001 (tld)
      call compute_brakets_0001 (tld)
      amp(1,1,h) = tld%oks_fl1_fl1b_fd1_i1_fd1b_o1
    end do
!$OMP END PARALLEL DO
  ...
  type(thread_local_data), intent(inout) :: tld
      tld%oks_fl1_fl1b_fd1_i1_fd1b_o1 = 0
      tld%oks_fl1_fl1b_fd1_i1_fd1b_o1 = tld%oks_fl1_fl1b_fd1_i1_fd1b_o1 &
         + tld%owf_fa_p12*( &
         + v_ff(qdwn,tld%owf_fd1b_o1_p3,tld%owf_fd1_i1_p4))
      tld%oks_fl1_fl1b_fd1_i1_fd1b_o1 = tld%oks_fl1_fl1b_fd1_i1_fd1b_o1 &
         + tld%owf_fz_p12*( &
         + va_ff(gncdwn(1),gncdwn(2),tld%owf_fd1b_o1_p3,tld%owf_fd1_i1_p4))
      tld%oks_fl1_fl1b_fd1_i1_fd1b_o1 = &
         - tld%oks_fl1_fl1b_fd1_i1_fd1b_o1 ! 2 vertices, 1 propagators
